...
public class Test2Fragment extends BaseFragment {
    public static final String LOG_TAG = Test2Fragment.class.getSimpleName();

    @Bind(R.id.generallist_recycler_view)
    RecyclerView generalItemsRv;

    private Context context;
    private static final String TOOLBAR_TITLE = "Test 2";
    ...
    public static BaseFragment createInstance() {
        final BaseFragment fragment = new Test2Fragment();
